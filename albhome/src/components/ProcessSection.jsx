import { Phone, Shield, Truck, Home, CheckCircle, ArrowRight } from 'lucide-react'
...
export default function ProcessSection() {
  return (
    <>
      {/* ===== Process Hero ===== */}
      <section id="process" className="py-20 sm:pt-28 sm:pb-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold text-primary mt-4 uppercase tracking-wide">
              From First Call<br className="sm:hidden" /> to Front Door
            </h2>
