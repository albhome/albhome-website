    ...
    <section id="home" className="relative min-h-[90vh] flex items-center bg-black overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-0">
        <div className="max-w-3xl">
          {/* Tagline */}
          <p className="text-accent font-heading tracking-[0.2em] text-xs uppercase mb-3">
            Designed with care, built without compromise
          </p>

          {/* Main heading - Oswald all-caps style like SnapBuild */}
          <h1 className="font-heading text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-tight uppercase">
            ALB Home
            <br />
          ...
          {/* Description */}
          <p className="text-white/60 text-base sm:text-lg max-w-xl mt-5 leading-relaxed">
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            <a
              href="#modular-homes"
              className="inline-flex items-center gap-2 bg-accent hover:bg-accent-dark text-primary font-semibold px-7 py-3 rounded-lg transition-all hover:shadow-lg hover:shadow-accent/25 text-sm uppercase tracking-wider"
            >
              View Our Homes
            </a>
            <a
              href="#contact"
              className="inline-flex items-center gap-2 border-2 border-white/20 text-white hover:border-accent hover:text-accent px-7 py-3 rounded-lg transition-all text-sm uppercase tracking-wider"
            >
              <Play size={14} />
              Get a Quote
            </a>
          ...
          {/* Stats strip */}
          <div className="grid grid-cols-3 gap-6 mt-10 pt-6 border-t border-white/10 max-w-lg">
            {[
