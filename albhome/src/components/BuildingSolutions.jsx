import { Ruler, ShieldCheck, LayoutDashboard, Building2, CookingPot, Hammer } from 'lucide-react'
...
const solutions = [
  ...
  {
    icon: Hammer,
    title: 'Three Structural Systems',
    desc: 'Choose from Timber Frame, Light Steel, or Aluminium construction. Each system offers unique benefits in strength, weight, insulation, and cost — giving you full control over your build.',
  },
  {
    icon: ShieldCheck,
  ...
  {
    icon: Building2,
    title: 'Expandable Home Solutions',
    desc: 'Fully customisable expandable homes built to Australian standards. Designed for comfort, energy efficiency, and rapid on-site assembly — available in 20FT, 30FT, and 40FT configurations.',
  },
  {
    icon: CookingPot,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto mt-4 text-lg">
            From concept to completion, we provide comprehensive project support — including three structural systems to choose from: Timber Frame, Light Steel, and Aluminium.
          </p>
        </div>
